...
public class J12_UserService {
	...
	// 위 Scanner에 new Scanner를 입력해도 되지만, 그렇게 되면 class만 생성해도 scanner를 생성한다.
	// J12_UserService를 생성할때만 메모리에 할당을 줄려고 따로 만든다.		
	}
	...
	private char inputSelect(String menuName) {
		...
		//charAt(0)는 scanner에서 입력받은 문자열의 첫글자만 잘라서 값을 대입해준다.
		scanner.nextLine();
		return select; 
	}
	...
	private void showMainMenu() {
		...
		System.out.println("3. 이름으로 사용자 조회");
